...
const PAIRS = [
  ...
  { key: 'xlf_xlu',  label: 'XLF / XLU',  num: 'XLF',  den: 'XLU', tier: 2, up: 'Financials vs Utilities — rates/cyclical' },
  // Tier 3 — breadth & style (clean but non-timing)
  { key: 'rsp_spy',  label: 'RSP / SPY',  num: 'RSP',  den: 'SPY', tier: 3, up: 'Equal vs Cap weight — breadth' },
  { key: 'iwm_spy',  label: 'IWM / SPY',  num: 'IWM',  den: 'SPY', tier: 3, up: 'Small vs Large — risk appetite' },
  { key: 'ivw_ive',  label: 'IVW / IVE',  num: 'IVW',  den: 'IVE', tier: 3, up: 'Growth vs Value — style' },
  // Tier 4 — cross-asset confirmation (coincident / contrarian on forward returns)
  { key: 'spy_gld',  label: 'SPY / Gold', num: 'SPY',  den: 'GLD', tier: 4, up: 'Stocks vs Gold — risk vs fear' },
  { key: 'copx_gld', label: 'Copper / Gold', num: 'COPX', den: 'GLD', tier: 4, up: 'Copper vs Gold — reflation' },
  { key: 'hyg_lqd',  label: 'HYG / LQD',  num: 'HYG',  den: 'LQD', tier: 4, up: 'Junk vs Quality — credit risk' },
  { key: 'xle_xlk',  label: 'XLE / XLK',  num: 'XLE',  den: 'XLK', tier: 4, up: 'Energy vs Tech — inflation/value' },
];
